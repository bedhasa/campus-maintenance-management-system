...
class MeSettingsController extends ModuleController
{
    ...
    private function payload(UserSetting $setting): array
    {
        return [
            ...
            'default_dashboard_filter' => $setting->default_dashboard_filter ?? 'all',
    ...
    {
        $user = $request->user();
        $setting = UserSetting::query()->firstOrCreate(['user_id' => $user->id], $this->defaults());
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'default_dashboard_filter' => ['sometimes', 'string', 'max:50'],
        ...
        if (array_key_exists('default_location', $validated)) {
        ...
        if (array_key_exists('default_dashboard_filter', $validated)) {
            $updates['default_dashboard_filter'] = $validated['default_dashboard_filter'];
        }
