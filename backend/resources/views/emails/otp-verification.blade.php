...
<body style="margin:0;padding:0;background:#f8fafc;font-family:Arial,Helvetica,sans-serif;color:#0f172a;">
    <div style="max-width:600px;margin:0 auto;padding:32px 16px;">
        <div style="background:#ffffff;border:1px solid #e2e8f0;border-radius:20px;padding:32px;">
            <p style="margin:0 0 12px;font-size:12px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:#1d4ed8;">Hawassa University CMMS</p>
            <h1 style="margin:0 0 16px;font-size:28px;line-height:1.2;">Your verification code</h1>
            <p style="margin:0 0 20px;font-size:15px;line-height:1.7;color:#475569;">
                Hello {{ $user->fname ?? 'there' }}, use the code below to verify your account. It expires in 5 minutes.
            </p>
